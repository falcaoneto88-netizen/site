...
export const HarmonizacaoBenefits = () => {
    return (
        <EditableSectionColors sectionId="harmoBenefits" colors={BEN_COLORS}>
            {(colors) => (
                    ...
                    <div className="md:hidden flex flex-col">
                        <div className="relative w-full aspect-square overflow-hidden">
                            <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut" }} className="w-full h-full">
                                <EditableImage id="harmo_benefits_img_mobile" defaultSrc="/assets/harmonizacao/benefits_smile.jpg" alt="Benefícios da harmonização orofacial" className="w-full h-full object-cover" />
                            </motion.div>
                        ...
                        <div className="px-6 pt-6 pb-10">
                            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                ...
                                <h2 className="text-2xl md:text-[30px] font-serif font-medium leading-[1.1] mb-4">
                                    <span style={{ color: colors.titleAccent }} className="italic"><EditableText id="harmo_benefits_title_1" defaultText="Benefícios " /></span>
                                    <span style={{ color: colors.title }}><EditableText id="harmo_benefits_title_2" defaultText="da harmonização orofacial" /></span>
                                </h2>
                                <div style={{ color: colors.text }} className="space-y-3">
                                    <EditableText id="harmo_benefits_p1" as="p" defaultText="Os procedimentos de harmonização orofacial ajudam a melhorar a harmonia do rosto, suavizar sinais do envelhecimento e valorizar os traços naturais do paciente." className="text-sm leading-relaxed font-light block" />
                                    <EditableText id="harmo_benefits_p2" as="p" defaultText="Além de melhorar a aparência, esses tratamentos podem contribuir para o aumento da autoestima e da confiança." className="text-sm leading-relaxed font-light block" />
                                    <EditableText id="harmo_benefits_p3" as="p" defaultText="Com planejamento adequado e execução cuidadosa, é possível alcançar resultados naturais e equilibrados, respeitando as características individuais de cada rosto." className="text-sm leading-relaxed font-light block" />
                                </div>
                            </motion.div>
                        </div>
                    </div>
                    <div className="hidden md:block min-h-[70vh]">
                        <div className="absolute inset-0 z-0">
                            <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut" }} className="relative w-full h-full">
                                <EditableImage id="harmo_benefits_img" defaultSrc="/assets/harmonizacao/benefits_smile.jpg" alt="Benefícios da harmonização orofacial" className="absolute right-0 top-0 h-full w-[65%] lg:w-[60%] max-w-[1100px] object-cover object-[80%_center]" />
