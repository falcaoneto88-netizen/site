...
export const FacetasBenefits = () => {
    return (
        <EditableSectionColors sectionId="facetasBenefits" colors={BEN_COLORS}>
            {(colors) => (
                    ...
                    <div className="md:hidden flex flex-col">
                        <div className="relative w-full aspect-square overflow-hidden">
                            <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut" }} className="w-full h-full">
                                <EditableImage id="facetas_benefits_img_mobile" defaultSrc="/assets/facetas/benefits_smile.jpg" alt="Benefícios das facetas em resina" className="w-full h-full object-cover" />
                            </motion.div>
                        ...
                        <div className="px-6 pt-6 pb-10">
                            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                ...
                                <h2 className="text-2xl md:text-[30px] font-serif font-medium leading-[1.1] mb-4">
                                    <span style={{ color: colors.titleAccent }} className="italic"><EditableText id="facetas_benefits_title_1" defaultText="Benefícios " /></span>
                                    <span style={{ color: colors.title }}><EditableText id="facetas_benefits_title_2" defaultText="das facetas em resina" /></span>
                                </h2>
                                <div style={{ color: colors.text }} className="space-y-3">
                                    <EditableText id="facetas_benefits_p1" as="p" defaultText="As facetas em resina permitem melhorar a estética do sorriso de forma rápida e minimamente invasiva." className="text-sm leading-relaxed font-light block" />
                                    <EditableText id="facetas_benefits_p2" as="p" defaultText="Entre os principais benefícios estão a possibilidade de corrigir imperfeições visuais, melhorar a harmonia do sorriso e valorizar a aparência dos dentes de maneira natural." className="text-sm leading-relaxed font-light block" />
                                    <EditableText id="facetas_benefits_p3" as="p" defaultText="Com planejamento adequado e execução cuidadosa, o tratamento pode proporcionar um sorriso mais equilibrado e mais confiança ao sorrir." className="text-sm leading-relaxed font-light block" />
                                </div>
                            </motion.div>
                        </div>
                    </div>
                    <div className="hidden md:block min-h-[70vh]">
                        <div className="absolute inset-0 z-0">
                            <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut" }} className="relative w-full h-full">
                                <EditableImage id="facetas_benefits_img" defaultSrc="/assets/facetas/benefits_smile.jpg" alt="Benefícios das facetas em resina" className="absolute right-0 top-0 h-full w-[65%] lg:w-[60%] max-w-[1100px] object-cover object-[80%_center]" />
