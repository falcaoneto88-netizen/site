...
const procedures = [
    { title: "Cárie profunda com comprometimento da polpa", image: "/assets/endodontia/proc_carie.jpg", delay: 0 },
    { title: "Trauma ou fratura dentária", image: "/assets/endodontia/proc_trauma.jpg", delay: 0.06 },
    { title: "Infecção ou abscesso na raiz do dente", image: "/assets/endodontia/proc_infeccao.jpg", delay: 0.12 },
    { title: "Retratamento de canal anterior", image: "/assets/endodontia/proc_retratamento.jpg", delay: 0.18 },
    { title: "Sensibilidade persistente ao frio ou calor", image: "/assets/endodontia/proc_sensibilidade.jpg", delay: 0.24 },
];

export const EndodontiaProcedures = () => {
    return (
        <EditableSectionColors sectionId="endodontiaProc" colors={PROC_COLORS}>
            {(colors) => (
                <section className="py-14 md:py-24 relative overflow-hidden" style={{ backgroundColor: colors.bg }}>
                    ...
                    <div className="container mx-auto px-4 md:px-6 relative z-10">
                        <EditableElement id="endo_proc_header_el" label="Cabeçalho">
                            <div className="text-center max-w-4xl mx-auto mb-10 md:mb-16 px-4">
                                <h2 className="text-2xl md:text-[30px] font-serif leading-tight italic" style={{ color: colors.title }}>
                                    <EditableText id="endo_proc_header" defaultText="Após avaliação clínica e exames, o tratamento pode ser indicado em situações como:" />
                                </h2>
                            </div>
                        </EditableElement>
                            ...
                            {procedures.map((proc, index) => {
                                ...
                                return (
                                    <div key={index} className={isLastOdd ? 'col-span-2 lg:col-span-1' : ''}>
                                        <EditableElement id={`endo_proc_card_${index}_el`} label={proc.title.substring(0, 20)}>
                                            <motion.div
                                            ...
                                            >
                                                ...
                                                <div className="absolute inset-0 flex items-end justify-center p-4 md:p-6 pointer-events-none">
                                                    <h3 className="text-sm md:text-base font-serif font-bold leading-snug text-center select-all" style={{ color: colors.cardTitle }}>
                                                        <EditableText id={`endo_proc_title_${index}`} defaultText={proc.title} />
                                                    </h3>
                                                </div>
                                            </motion.div>
                                        </EditableElement>
