...
export const ProteseHero = () => {
    return (
        <EditableSectionColors sectionId="proteseHero" colors={HERO_COLORS}>
            {(colors) => (
                    ...
                    <div className="md:hidden flex flex-col">
                        <div className="relative w-full aspect-square overflow-hidden">
                            <motion.div initial={{ opacity: 0, scale: 1.1 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.5, ease: "easeOut" }} className="w-full h-full">
                                <EditableImage id="protese_hero_bg_mobile" defaultSrc="/assets/protese/hero_protese.jpg" alt="Prótese Dentária Oral Unic" className="w-full h-full object-cover" />
                            </motion.div>
                        ...
                        <div className="px-6 pt-6 pb-10">
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                <h1 className="text-2xl md:text-[30px] font-serif font-medium leading-[1.1] mb-4">
                                    <span style={{ color: colors.title }}><EditableText id="protese_hero_t1" defaultText="Prótese dentária com " /></span>
                                    <span style={{ color: colors.titleAccent }} className="italic"><EditableText id="protese_hero_t2" defaultText="planejamento" /></span>
                                    <span style={{ color: colors.title }}><EditableText id="protese_hero_t3" defaultText=", estética natural e " /></span>
                                    <span style={{ color: colors.titleAccent }} className="italic"><EditableText id="protese_hero_t4" defaultText="conforto ao mastigar" /></span>
                                </h1>
                                <div style={{ color: colors.desc }}>
                                    <EditableText id="protese_hero_desc" as="p" defaultText="Desgaste dentário, falhas no sorriso ou dificuldade para mastigar não precisam fazer parte da sua rotina. Na Oral Unic, realizamos tratamentos com prótese dentária focados em devolver função, estética e conforto, sempre com planejamento individualizado e acompanhamento especializado." className="text-sm mb-6 leading-relaxed font-light block" />
                                </div>
                                <EditableElement id="protese_hero_ctas_el" label="Botões">
                                    <div className="flex flex-col gap-3">
                                        <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="btn-primary group" style={{ backgroundColor: colors.btnPrimary }}>
                                            <EditableText id="protese_hero_cta" defaultText="Agende uma Consulta" />
                    ...
                    <div className="hidden md:block min-h-[90vh]">
                        <div className="absolute inset-0 z-0">
                            <motion.div initial={{ opacity: 0, scale: 1.1 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.5, ease: "easeOut" }} className="relative w-full h-full">
                                <EditableImage id="protese_hero_bg" defaultSrc="/assets/protese/hero_protese.jpg" alt="Prótese Dentária Oral Unic" className="absolute right-0 top-0 h-full w-[65%] lg:w-[60%] max-w-[1100px] object-cover object-[80%_center]" />
                        ...
                        <div className="max-w-[1600px] mx-auto w-full px-6 relative z-30 pt-36 min-h-[90vh] flex items-center">
                            <div className="max-w-md lg:max-w-xl">
                                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                    ...
                                    <div style={{ color: colors.desc }}>
                                        <EditableText id="protese_hero_desc" as="p" defaultText="Desgaste dentário, falhas no sorriso ou dificuldade para mastigar não precisam fazer parte da sua rotina. Na Oral Unic, realizamos tratamentos com prótese dentária focados em devolver função, estética e conforto, sempre com planejamento individualizado e acompanhamento especializado." className="text-sm mb-8 leading-relaxed max-w-sm font-light block" />
                                    </div>
                                    <EditableElement id="protese_hero_ctas_el" label="Botões">
