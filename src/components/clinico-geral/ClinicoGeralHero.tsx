...
export const ClinicoGeralHero = () => {
    return (
        <EditableSectionColors sectionId="clinicoHero" colors={HERO_COLORS}>
            {(colors) => (
                    ...
                    <div className="md:hidden flex flex-col">
                        <div className="relative w-full aspect-square overflow-hidden">
                            <motion.div initial={{ opacity: 0, scale: 1.1 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.5, ease: "easeOut" }} className="w-full h-full">
                                <EditableImage id="clinico_hero_bg_mobile" defaultSrc="/assets/clinico-geral/hero_clinico.jpg" alt="Clínico Geral Oral Unic" className="w-full h-full object-cover" />
                            </motion.div>
                        ...
                        <div className="px-6 pt-6 pb-10">
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                <h1 className="text-2xl md:text-[30px] font-serif font-medium leading-[1.1] mb-4">
                                    <span style={{ color: colors.title }}><EditableText id="clinico_hero_t1" defaultText="Cuidado odontológico completo para manter sua " /></span>
                                    <span style={{ color: colors.titleAccent }} className="italic"><EditableText id="clinico_hero_t2" defaultText="saúde bucal em dia" /></span>
                                </h1>
                                <div style={{ color: colors.desc }}>
                                    <EditableText id="clinico_hero_desc" as="p" defaultText="Prevenção, diagnóstico e tratamentos iniciais são fundamentais para evitar problemas maiores no futuro. Na Oral Unic, o atendimento clínico geral é realizado com atenção, tecnologia e foco na saúde e bem-estar do paciente." className="text-sm mb-6 leading-relaxed font-light block" />
                                </div>
                                <EditableElement id="clinico_hero_ctas_el" label="Botões">
                                    <div className="flex flex-col gap-3">
                                        <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="btn-primary group" style={{ backgroundColor: colors.btnPrimary }}>
                                            <EditableText id="clinico_hero_cta" defaultText="Agende uma Consulta" />
                    ...
                    <div className="hidden md:block min-h-[90vh]">
                        <div className="absolute inset-0 z-0">
                            <motion.div initial={{ opacity: 0, scale: 1.1 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.5, ease: "easeOut" }} className="relative w-full h-full">
                                <EditableImage id="clinico_hero_bg" defaultSrc="/assets/clinico-geral/hero_clinico.jpg" alt="Clínico Geral Oral Unic" className="absolute right-0 top-0 h-full w-[65%] lg:w-[60%] max-w-[1100px] object-cover object-[80%_center]" />
                        ...
                        <div className="max-w-[1600px] mx-auto w-full px-6 relative z-30 pt-36 min-h-[90vh] flex items-center">
                            <div className="max-w-md lg:max-w-xl">
                                <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                    ...
                                    <div style={{ color: colors.desc }}>
                                        <EditableText id="clinico_hero_desc" as="p" defaultText="Prevenção, diagnóstico e tratamentos iniciais são fundamentais para evitar problemas maiores no futuro. Na Oral Unic, o atendimento clínico geral é realizado com atenção, tecnologia e foco na saúde e bem-estar do paciente." className="text-sm mb-8 leading-relaxed max-w-sm font-light block" />
                                    </div>
                                    <EditableElement id="clinico_hero_ctas_el" label="Botões">
