...
export const ImplantBenefits = () => {
    return (
        <EditableSectionColors sectionId="implantBenefits" colors={BEN_COLORS}>
            {(colors) => (
                    ...
                    <div className="md:hidden flex flex-col">
                        <div className="relative w-full aspect-square overflow-hidden">
                            <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut" }} className="w-full h-full">
                                <EditableImage id="benefits_img_mobile" defaultSrc="/assets/implantes/benefits_smile.jpg" alt="Benefícios do Implante Dentário" className="w-full h-full object-cover" />
                            </motion.div>
                        ...
                        <div className="px-6 pt-6 pb-10">
                            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "easeOut" }}>
                                ...
                                <h2 className="text-2xl md:text-[30px] font-serif font-medium leading-[1.1] mb-4">
                                    <span style={{ color: colors.titleAccent }} className="italic"><EditableText id="benefits_title_1" defaultText="Benefícios do " /></span>
                                    <span style={{ color: colors.title }}><EditableText id="benefits_title_2" defaultText="Implante Dentário" /></span>
                                </h2>
                                <div style={{ color: colors.text }} className="space-y-3">
                                    <EditableText id="benefits_p1" as="p" defaultText="Optar pelo implante dentário significa recuperar muito mais do que um dente. Os pacientes relatam melhora significativa na mastigação, mais segurança ao falar e sorrir, além de um impacto positivo direto na autoestima e na qualidade de vida." className="text-sm leading-relaxed font-light block" />
                                    <EditableText id="benefits_p2" as="p" defaultText="Quando bem planejado, o implante se integra de forma natural ao sorriso e oferece uma solução estável e duradoura." className="text-sm leading-relaxed font-light block" />
                                </div>
                            </motion.div>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:block min-h-[70vh]">
                        <div className="absolute inset-0 z-0">
                            <motion.div initial={{ opacity: 0, scale: 1.05 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 1.2, ease: "easeOut" }} className="relative w-full h-full">
                                <EditableImage id="benefits_img" defaultSrc="/assets/implantes/benefits_smile.jpg" alt="Benefícios do Implante Dentário" className="absolute right-0 top-0 h-full w-[65%] lg:w-[60%] max-w-[1100px] object-cover object-[80%_center]" />
